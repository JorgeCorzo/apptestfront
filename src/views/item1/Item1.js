...
function Item1() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        let res = await fetch('https://enigmatic-dawn-92117.herokuapp.com/api/menuid?id=1')
  ...
  async function submitPerson(values) {
    ...
    try {
      ...
      let data = await res.json()
      if(data){
        let res1 = await fetch('https://enigmatic-dawn-92117.herokuapp.com/api/menuid?id=1')
